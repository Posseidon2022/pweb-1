...
exit;
  ...
  echo -e 'by: @Igorhenri0407' >/usr/lib/telegram
  msg -bar
...
wget https://github.com/Posseidon2022/omaetalegna/raw/painel/install/pweb > /dev/null 2>&1
...
wget https://github.com/Posseidon2022/omaetalegna/raw/painel/install/verpweb > /dev/null 2>&1
