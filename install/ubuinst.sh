...
cd /bin || exit
rm omaetalegna > /dev/null 2>&1
wget https://github.com/Posseidon2022/omaetalegna/raw/painel/install/omaetalegna > /dev/null 2>&1
chmod 777 omaetalegna > /dev/null 2>&1
clear
[[ ! -d /bin/pomaetalegna ]] && mkdir /bin/pomaetalegna
cd /bin/pomaetalegna || exit
rm *.sh ver* > /dev/null 2>&1
wget https://github.com/Posseidon2022/omaetalegna/raw/painel/install/verifatt.sh > /dev/null 2>&1
wget https://github.com/Posseidon2022/omaetalegna/raw/painel/install/veromaetalegna > /dev/null 2>&1
wget https://github.com/Posseidon2022/omaetalegna/raw/painel/install/verweb > /dev/null 2>&1
verp=$(sed -n '1 p' /bin/pomaetalegna/veromaetalegna| sed -e 's/[^0-9]//ig') &>/dev/null
verw=$(sed -n '1 p' /bin/pomaetalegna/verweb| sed -e 's/[^0-9]//ig') &>/dev/null
echo -e "$verp" >/bin/pomaetalegna/attomaetalegna
echo -e "$verw" >/bin/pomaetalegna/attweb
...
wget https://github.com/Posseidon2022/omaetalegna/raw/painel/install/gestorssh.zip > /dev/null 2>&1
...
echo -e "                              \033[1;31mBy @LexLuthor\033[1;36m"
echo ""
chave=$(curl -sSL "raw.githubusercontent.com/Posseidon2022/omaetalegna/painel/install/chave") &>/dev/null
...
echo ""
echo -e "\033[1;36m PAGINA TESTE-FREE:\033[1;37m http://$IP/teste-free.php\033[0m"
echo ""
...
echo ""
echo -e "\033[1;31m \033[1;33mCOMANDO PRINCIPAL: \033[1;32momaetalegna\033[0m"
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@LexLuthor\033[0m"
echo ""
